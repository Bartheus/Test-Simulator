...
export class QuestionsService {
    ...
    questions: Question[] = [
    {
      ...
      answers: [
        {option: "ls", correct: false, selected: false},
        {option: "delete", correct: false, selected: false},
        {option: "remove", correct: false, selected: false},
        {option: "rmdir", correct: true,selected: false}
      ],
      type: "singleChoice"
    },
    // {
    ...
    // },
    {
      ...
      answers: [
        {option:"cat file1 file2 file3 > file", correct: true, selected: false },
        {option:"cat file1 > file && cat file2 >> file && cat file3 >> file", correct: true, selected: false},
        {option:"cat file1 >> file; cat file2 >> file; cat file3 >> file", correct: true, selected: false},
        {option:"cat file1 > file; cat file2 > file; cat file3 > file", correct: false, selected: false},
      ],
      type: 'multipleChoice'
    },
    // {
